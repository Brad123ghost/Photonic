...
<html lang="en">
    <head>
        ...
        <title>Photonic Photography | Home</title>
            ...
            <div class="nav-inner-bottom">
                <div class="links">
                    <ul>
                        ...
                        <li>
                            <form action='opencontroller.php' id='allproductformheader' class='viewallproducts' method='POST'>
        ...
        <div class="wrapper" id="wrapper">
            <div class="banner">
                ...
                <form method='POST'>
                    ...
                    <button type='submit' class="banner-buy"><img src="images/banner.png" alt="Promotional Banner"></button>
                </form>
            </div>
            <div class="title-container swiper-title-container">
                <h1>Latest Products</h1>
                
                <form action='opencontroller.php' id='allproductform' class='viewallproducts' method='POST'>
                    <input type='hidden' name='action' value='viewallproducts'>
                    <button type='submit' class="viewall-btn">
                        View all Products >
                    </button>
                </form>
            </div>
            ...
            <div class="title-container swiper-title-container">
                ...
                <form action='opencontroller.php' id='alldepartmentform' class='viewallproducts' method='POST'>
                    <input type='hidden' name='action' value='viewalldepartments'>
                    <button type='submit' class="viewall-btn">
                ...
                <div class="swiper-wrapper">
                            <?php
                                foreach ($categories as $row) {
                                    ...
                                    <div class='swiper-slide'>
                                        <div class='product_wrapper'>
                                            <form action='opencontroller.php' class='categoryform card category-card' method='POST'>
                                                <input type='hidden' name='categoryid' value=" . $row['categoryid'] .">
                                                <input type='hidden' name='action' value='searchcategory'>
                                                <button type='submit' class='category-card-btn'>
                                                    <img class='categoryimage' src='" . $row['categoryimage'] ."' alt='" . $row['categorytype'] . "'>
                                                    <br>
                                                    <span class='categorytype'>" . $row['categorytype'] . "</span>
                                                </button>
                                            </form>
                                        </div>
                                    </div>";
